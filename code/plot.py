...
# %%
dataFrame = pd.read_csv("/home/mddo/stage/M2S4/output/FY/accuracy_para_3.csv")
# %%
data = pd.DataFrame(dataFrame["acc"])
# %%
sns.lineplot(data=data, palette="tab10", linewidth=2.5, color = "orange")
plt.rcParams["figure.figsize"] = (30,4)
