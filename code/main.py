...
def main():
    ...
    with open(save_file_report,"a") as save:
        tree_path = "/home/mddo/stage/M2S4/output/forest/HFI_NI_PROM/tree_8_9_8_2817_95.0.json"
        with open(tree_path) as json_data:
            ...
            for i in range(len(diploid_files_data)):
                #define test data
                test_df = pd.read_csv("/home/mddo/stage/M2S4/output/FY/diploid_/diploid_0/df/test/{}.csv".format(type_df))
